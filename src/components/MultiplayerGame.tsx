    ...
    <div className="min-h-screen bg-gradient-to-br from-green-800 via-green-700 to-green-900 relative overflow-hidden">
        ...
        return (
          ...
          >
            ...
            <div className="flex gap-1 justify-center">
              {player.hand.slice(0, Math.min(5, player.hand.length)).map((_: any, cardIndex: number) => (
                <Card
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        <div className="text-center mb-4">
          ...
          {topCard && (
            <div className="text-sm text-white opacity-75">
              Last: {getCardDisplay(topCard.rank)}{getSuitSymbol(topCard.suit)}
            </div>
          )}
        </div>
        ...
        <div className="flex justify-center mt-4">
          {gameState.gamePhase === 'setup' && humanPlayer.faceUpCards.length === 3 && isMyTurn && (
            <button

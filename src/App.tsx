...
function App() {
  ...
  const scaleClass = resolution === '1080p' ? 'scale-[0.8]' : 
                     resolution === 'mobile' ? 'scale-[0.6]' : 'scale-100';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-800 via-green-700 to-green-900 relative overflow-hidden">
      ...
      {(gameState.players.length === 2 || gameState.players.length > 3) && (
        <div className={`absolute ${resolution === 'mobile' ? 'top-2 left-1/2 transform -translate-x-1/2' : 'top-8 left-1/2 transform -translate-x-1/2'} ${scaleClass}`}>
      ...
      {gameState.players.length === 3 && (
        <div className={`absolute ${resolution === 'mobile' ? 'left-1 top-1/4 transform -translate-y-1/2' : 'left-12 top-1/2 transform -translate-y-1/2'} ${scaleClass}`}>
        <div className="text-center mb-2">
      ...
      {gameState.players.length > 3 && (
        <div className={`absolute ${resolution === 'mobile' ? 'left-1 top-1/3 transform -translate-y-1/2' : 'left-12 top-1/2 transform -translate-y-1/2'} ${scaleClass}`}>
        <div className="text-center mb-2">
          <div className={`text-sm font-bold ${gameState.currentPlayerIndex === 1 ? 'text-yellow-300' : 'text-white'}`}>
            {gameState.players[1]?.name}
          </div>
      ...
      {gameState.players.length === 3 && (
        <div className={`absolute ${resolution === 'mobile' ? 'right-1 top-1/4 transform -translate-y-1/2' : 'right-12 top-1/2 transform -translate-y-1/2'} ${scaleClass}`}>
        <div className="text-center mb-2">
      ...
      {gameState.players.length > 3 && (
        <div className={`absolute ${resolution === 'mobile' ? 'right-1 top-2/3 transform -translate-y-1/2' : 'right-12 top-1/2 transform -translate-y-1/2'} ${scaleClass}`}>
        <div className="text-center mb-2">
